...
boxe1 = Boxe.create(name: "Box1", description: "Location box rue Paradis", caracteristics: "Surface: 20m2", address:"23 rue Paradis", price_per_day: 20, user: user1)

user2 = User.create(first_name: "Jessica", last_name: "Fiedler", email: "jess.fiedler83860@gmail.com", password: "123456")
boxe2 = Boxe.create(name: "Box2", description: "Location garage", caracteristics: "Surface: 30m2", address:"4 rue Republique", price_per_day: 30, user: user2)

user3 = User.create(first_name: "Florian", last_name: "Couraud", email: "f.couraud13@gmail.com", password: "123456")
boxe3 = Boxe.create(name: "Box3", description: "Location espace prés de Castellane", caracteristics: "Surface: 40m2", address:"27 Av du Prado", price_per_day: 40, user: user3)

user4 = User.create(first_name: "Brice", last_name: "Bickelmann", email: "bickelmann.b@gmail.com", password: "123456")
boxe4 = Boxe.create(name: "Box4", description: "Location cave", caracteristics: "Surface: 25m2", address:"4 rue Marechal", price_per_day: 25, user: user4)
